...
namespace x_IMU_API
{
    ...
    public class QuaternionData : xIMUdata
    {
        ...
        public QuaternionData QuaternionMultiplication(float[] quaternion)
        {
            float[] q = new float[]   { 0, 0, 0, 0 };
            float[] vv1 = new float[] { 0, 0, 0 };
            float[] wv1 = new float[] { 0, 0, 0 };
            float[] w1v = new float[] { 0, 0, 0 };
            ...
            q[0] = Quaternion[0] * quaternion[0] - (Quaternion[1] * quaternion[1] + Quaternion[2] * quaternion[2] + Quaternion[3] * quaternion[3]);

            vv1[0] = Quaternion[2] * quaternion[3] - quaternion[2] * Quaternion[3];
            vv1[1] = Quaternion[3] * quaternion[1] - quaternion[3] * Quaternion[1];
            vv1[2] = Quaternion[1] * quaternion[2] - quaternion[1] * Quaternion[2];

            wv1[0] = Quaternion[0] * quaternion[1];
            wv1[1] = Quaternion[0] * quaternion[2];
            wv1[2] = Quaternion[0] * quaternion[3];

            w1v[0] = quaternion[0] * Quaternion[1];
            w1v[1] = quaternion[0] * Quaternion[2];
            w1v[2] = quaternion[0] * Quaternion[3];

            Quaternion[0] = q[0];
            Quaternion[1] = vv1[0] + wv1[0] + w1v[0];
            Quaternion[2] = vv1[1] + wv1[1] + w1v[1];
            Quaternion[3] = vv1[2] + wv1[2] + w1v[2];
        ...
        {
            return degree / 57.2957795130823f;
        }
